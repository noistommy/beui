...
export const gridProps = [
  ...
  },
  {
    name: 'md',
    type: 'Number',
    description: 'breakPoint: md 일때 균등 분할 수',
    default: 'false',
    required: false,
  },
  {
    name: 'sm',
    type: 'Number',
    description: 'breakPoint: sm 일때 균등 분할 수',
    default: 'false',
    required: false,
  },
  {
    name: 'xs',
    type: 'Number',
    description: 'breakPoint: xs 일때 균등 분할 수',
    default: 'false',
    required: false,
  },
  {
    name: 'justify',
    type: 'none | left | center | right | between | around',
    description: '가로 정렬 옵션',
    default: 'left',
    required: false,
  },
  {
...
export const columnProps = [
  ...
  },
  {
    name: 'md',
    type: 'Number',
    description: 'breakPoint: md 일때 컬럼 영역 수',
    default: 'false',
    required: false,
  },
  {
    name: 'sm',
    type: 'Number',
    description: 'breakPoint: sm 일때 컬럼 영역 수',
    default: 'false',
    required: false,
  },
  {
    name: 'xs',
    type: 'Number',
    description: 'breakPoint: xs 일때 컬럼 영역 수',
    default: 'false',
    required: false,
  },
  {
    name: 'mdOffset',
    type: 'Number',
    description: 'breakPoint: md 일때 오프셋 컬럼 영역 수',
    default: 'false',
    required: false,
  },
  {
    name: 'smOffset',
    type: 'Number',
    description: 'breakPoint: sm 일때 오프셋 컬럼 영역 수',
    default: 'false',
    required: false,
  },
  {
    name: 'xsOffset',
    type: 'Number',
    description: 'breakPoint: xs 일때 오프셋 컬럼 영역 수',
    default: 'false',
    required: false,
  },
]
export const dosirakProps = [
  {
    name: 'dosirak',
    type: 'Boolean',
    description: '도시락 그리드 사용 여부',
    default: true,
    required: false,
  },
  {
  ...
  {
    name: 'justifyContent',
    type: 'none | left | center | right | between | around | evenly',
    description: '그리드 내 아이템 가로 정렬 옵션',
    default: null,
    required: false,
  },
  {
    name: 'justifyItems',
    type: 'none | left | center | right | between | around | evenly',
    description: '아이템 내 가로 정렬 옵션',
    default: null,
    required: false,
  },
  {
    name: 'alignContent',
    type: 'none | top | center | bottom',
    description: '그리드 내 아이템 가로 정렬 옵션',
    default: null,
    required: false,
  },
  ...
  },
  {
    name: 'round',
    type: 's | m | l | xl',
    description: '그리드 아이템 Radius 크기 설정',
    default: null,
    required: false,
  },
]
export const dosirakColumnProps = [
  {
    name: 'cal',
    type: 'Number',
    description: 'Grid Area - 컬럼 영역 수',
    default: null,
    required: false,
  },
  {
    name: 'row',
    type: 'Number',
    description: 'Grid Area - Row 영역 수',
    default: null,
    required: false,
  },
  {
  ...
  {
    name: 'justify',
    type: 'start | center | end | strech',
    description: 'column 내 컨텐츠 가로 정렬',
    default: 'false',
    required: false,
  },
  {
    name: 'align',
    type: 'start | center | end | strech',
    description: 'column 내 컨텐츠 세로 정렬',
    default: 'false',
    required: false,
  },
]
