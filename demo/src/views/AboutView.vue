...
<template>
  <div class="page-wrapper">
    ...
    <div class="input">
      <BeInput />
      <BeInput v-model="insertValue" :clear="true" />
      <BeInput icon-left="search" :clear="true" />
      <BeInput class="underline icon left">
        <i class="icon left xi-search"></i>
