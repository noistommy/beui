export const base_html_co = `<!-- Parent element 내부에 사용 -->
<div class="parent-element">
    ...
    <div class="be-badge">N</div>
</div>`
export const base_component = `<!-- Parent element 내부에 사용 -->
<div class="parent-element">
    ...
    <BeBadge>N</BeBadge>
</div>`
export const mark = `<!-- @mark: Boolean -->
<!-- default: false -->
<!-- html -->
<div class="parent-element">
    ...
...
export const shadow = `<!-- @shadow: Boolean -->
<!-- default: false -->
<!-- html -->
<div class="parent-element">
    ...
