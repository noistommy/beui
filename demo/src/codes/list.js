...
export const selection = `<!-- @selection: Boolean -->
<!-- @selectedType: {mark | bg | mark bg | bg text | bg text mark} -->
<!-- default: false -->
<BeList :selection="selection" :selected-type="selectedType"></BeList>`
export const sub_title = `<!-- script setup -->
<!-- const optionSubList = [] -->
<!-- { id: 1, option: 'option1', icon: 'xi-icon', sub: 'sub-option1' } -->
<BeList :options="optionSubList"></BeList>`
export const icon = `<!-- @icon: Boolean -->
<!-- default: false -->
<BeList :options="optionList" icon></BeList>`
export const border = `<!-- @border: Boolean -->
<!-- default: false -->
<BeList :options="optionList" border></BeList>`
export const image = `<!-- @image: Boolean -->
